...
#ifndef ANIMATIONS_LOGIN_H_
#define ANIMATIONS_LOGIN_H_

/**
 * @brief Simula un sleep tanto para windows como linux.
 * @param time
 */
...
/**
 * @fn void opening()
 * @brief 	Animacion al inicializar la app.
 */
void opening();

#endif /* ANIMATIONS_LOGIN_H_ */
