...
int controller_editEmployee(LinkedList *pArrayListEmployee) {
	...
	if (pArrayListEmployee != NULL) {
		...
		utn_getNumero(&idEmployee,
				"    [Bot_Apu]: Ingreses el ID a modificar: ",
		...
		if (index == -1) {
			...
			do {
				...
				case 1:
					...
					system("clear"); // linux
					showEmployee(pEmployee);
					if (utn_getNombre(nameEmployee, 128,
						...
						printf(
								"    [Bot_Apu]: Nombres actualizados con exitos!\n"
				...
				case 2:
					...
					if (utn_getNumero(&salaryEmployee,
						...
						printf(
								"    [Bot_Apu]: Sueldos actualizados con exitos!\n"
										"    [Bot_Apu]: Listes de nuevos los empleados para ver los cambios\n");
						sucess = 1;
					}
					break;
				case 3:
					...
					if (utn_getNumero(&hoursWorked,
						...
						printf(
								"    [Bot_Apu]: Horas actualizadas con exito! \n"
										"    [Bot_Apu]: Listes de nuevos los empleados para ver los cambios\n");
						sucess = 1;
					}
					break;
				...
				default:
					printf(
							"    [Bot_Apu]: [ERROR]. Opcion invalidas, escojas [1-4]\n");
				}
